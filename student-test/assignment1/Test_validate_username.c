...
/** 
 * should we have a setUp and tearDown for the malloc to prevent memory leak?
 * --Tom
*/
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(),malloc_username_from_conf_file(),"Names don't match");
}
